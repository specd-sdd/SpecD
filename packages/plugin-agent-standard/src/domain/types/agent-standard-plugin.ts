...
/**
 * Agent Skills standard implementation of the agent-plugin contract.
 */
export class AgentStandardAgentPlugin implements AgentPlugin {
  /**
   * Creates an Agent Skills standard plugin runtime.
   *
  ...
  /**
   * Installs Agent Skills standard skills into `.agents/skills`.
   *
  ...
  /**
   * Uninstalls Agent Skills standard skills from `.agents/skills`.
   *
   * @param config - Project configuration.
