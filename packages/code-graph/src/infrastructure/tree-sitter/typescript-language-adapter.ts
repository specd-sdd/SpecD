...
export class TypeScriptLanguageAdapter implements LanguageAdapter {
  ...
  keywords(): string[] {
    return [
      'import', 'export', 'class', 'interface', 'type', 'async', 'function', 'const',
      'let', 'var', 'readonly', 'string', 'boolean', 'number', 'any', 'Promise',
      'void', 'return', 'null', 'undefined', 'true', 'false', 'if', 'else', 'from',
      'of', 'in', 'new', 'this', 'super', 'extends', 'implements', 'as', 'is',
      'case', 'catch', 'try', 'finally', 'switch', 'default', 'break', 'continue',
      'do', 'while', 'yield', 'await', 'throw', 'typeof', 'instanceof', 'delete',
      'package', 'private', 'protected', 'public', 'static', 'enum', 'namespace',
      'constructor', 'never', 'unknown', 'symbol', 'bigint', 'object',
    ]
  }
