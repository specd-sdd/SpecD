...
- [`specs/core/storage/spec.md`](../storage/spec.md) — change directory naming (`YYYYMMDD-HHmmss-<name>`), storage paths
- [`specs/core/change-manifest/spec.md`](../change-manifest/spec.md) — `manifest.json` format and fields
