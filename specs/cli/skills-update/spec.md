...
- [`cli:skills-install`](../skills-install/spec.md) — file-write path logic and responsibility split
- [`core:config`](../../core/config/spec.md) — `GetSkillsManifest` use case, `ConfigWriter` port
