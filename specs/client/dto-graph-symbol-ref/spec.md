...
Client-side type for **Dto Graph Symbol Ref**, kept in parity with the matching `api:dto-*` spec so
...
- [`api:dto-graph-symbol-ref`](../../api/dto-graph-symbol-ref/spec.md) — mirror API DTO
