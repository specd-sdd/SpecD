...
Client-side type for **Dto Change Summary**, kept in parity with the matching `api:dto-*` spec so remote and embedded Studio render the same JSON the API emits.
...
- [`api:dto-change-summary`](../../api/dto-change-summary/spec.md) — mirror API DTO
