...
Maps kernel or graph results into the matching `dto-*` response for **Presenter Spec**. Presenters are pure formatting at the HTTP boundary so handlers do not embed lifecycle or validation logic.
...
- [`api:dto-spec`](../dto-spec/spec.md) — wire shape
