...
Maps kernel or graph results into the matching `dto-*` response for **Presenter Problem**. Presenters are pure formatting at the HTTP boundary so handlers do not embed lifecycle or validation logic.
...
- [`api:problem-json`](../problem-json/spec.md) — error shape
