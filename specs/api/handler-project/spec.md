...
- `GetProjectContext`
- project status aggregation (`ListChanges`, `ListDrafts`, `ListDiscarded`, list archived, graph stats via `createCodeGraphProvider`)
