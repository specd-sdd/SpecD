...
#### Scenario: Cross-workspace scoring
...
#### Scenario: File importer contribution
...
#### Scenario: Default filters exclude zero-score symbols
...
#### Scenario: --all removes all default filters
