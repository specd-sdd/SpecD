...
- [`specs/code-graph/graph-store/spec.md`](../graph-store/spec.md) — abstract
  graph-store contract implemented by this adapter
- [`specs/core/config/spec.md`](../../../core/config/spec.md) — `configPath` and
  derived graph/temp directories
- [`specs/code-graph/symbol-model/spec.md`](../symbol-model/spec.md) — persisted node
  and relation concepts
- [`specs/code-graph/workspace-integration/spec.md`](../workspace-integration/spec.md)
