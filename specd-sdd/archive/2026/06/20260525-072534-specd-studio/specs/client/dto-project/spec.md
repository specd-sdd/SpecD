...
Client-side type for **Dto Project**, kept in parity with the matching `api:dto-*` spec so remote and embedded Studio render the same JSON the API emits.
...
- [`api:dto-project`](../../api/dto-project/spec.md) — mirror API DTO
