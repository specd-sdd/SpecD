...
- **Mode:** change
- **Timestamp:** 20260721-234309
- **Change path:** `specd-sdd/changes/20260721-180012-long-lived-hosts-run-index-provider`
- **Verdict:** PASS (0 blocking findings; 1 soft wording note)
...
Plus consistency checks against direct deps (`sdk:run-index-project-graph`, `code-graph:composition`, `code-graph-sqlite-electron:sqlite-electron-store`, globals).
