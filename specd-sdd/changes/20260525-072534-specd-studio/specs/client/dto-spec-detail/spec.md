...
Client-side type for **Dto Spec Detail**, kept in parity with the matching `api:dto-*` spec so remote and embedded Studio render the same JSON the API emits.
...
- [`api:dto-spec-detail`](../../api/dto-spec-detail/spec.md) — mirror API DTO
