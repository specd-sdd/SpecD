# Verification: Change Tab Context
...
- **THEN** no tab-scoped context request is sent
- **AND** cache is retained until visible again

#### Scenario: Context tab loads compiled context when visible

- **GIVEN** active change
- **WHEN** user selects Context tab
