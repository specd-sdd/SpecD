...
- [ ] 1.1 Remove the obsolete standard skill template
...
- [ ] 1.2 Replace archive workflow guidance
...
- [ ] 1.3 Remove the legacy development skill
      ...
      (Req: Optimizer agents)
- [ ] 1.4 Update legacy development archive guidance
...
- [ ] 2.1 Remove the Claude standard-skill registration
...
- [ ] 3.1 Update the template-source specification
...
- [ ] 3.2 Update template-source verification scenarios
...
- [ ] 3.3 Update the optimizer-agent specification
      ...
      (Req: Optimizer agents)
- [ ] 3.4 Update optimizer-agent verification
...
- [ ] 4.2 Update Claude installation expectations
      ...
      (Req: Template migration, scenario: Obsolete metadata skill is absent)
- [ ] 4.3 Update Codex installation expectations
      ...
      Approach: assert the standard skill is absent while agent availability follows the plugin's capabilities.
      (Req: Template migration, scenario: Obsolete metadata skill is absent)
- [ ] 4.4 Update Copilot installation expectations
      ...
      Approach: assert the standard skill is absent while agent availability follows the plugin's capabilities.
      (Req: Template migration, scenario: Obsolete metadata skill is absent)
- [ ] 4.5 Update OpenCode installation expectations
      ...
      Approach: assert the standard skill is absent while agent availability follows the plugin's capabilities.
      (Req: Template migration, scenario: Obsolete metadata skill is absent)
- [ ] 4.6 Update Standard plugin installation expectations
