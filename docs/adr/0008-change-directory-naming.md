...
Chosen option: "Datetime prefix (`YYYYMMDD-HHmmss`)", because it provides chronological sorting without any coordination mechanism, and per-second precision is sufficient for practical collision avoidance.
